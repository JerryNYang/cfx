// Illustrated the difference between arguments and paramaters.
...
int main(void)
{
	...
	printf("The value of z = %f\n", z);
		...
		// In this third call, z is the argument to half_of()
	z = half_of(z);
	printf("The value of z = %f\n", z);
...
{
	/*
		k is the paramater. Each time half_of() is called.
